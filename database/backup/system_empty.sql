...
COPY public."attrGroups" (identifier, name, "order", visible, id, "tenantId", "createdBy", "updatedBy", "createdAt", "updatedAt", "deletedAt") FROM stdin;
\.
...
COPY public.attributes (identifier, name, "order", valid, visible, relations, "languageDependent", type, pattern, "errorMessage", lov, "richText", "multiLine", id, "tenantId", "createdBy", "updatedBy", "createdAt", "updatedAt", "deletedAt") FROM stdin;
\.
...
COPY public.items (identifier, path, name, "typeId", "typeIdentifier", "parentIdentifier", "values", "fileOrigName", "storagePath", "mimeType", id, "tenantId", "createdBy", "updatedBy", "createdAt", "updatedAt", "deletedAt") FROM stdin;
\.
...
COPY public.relations (identifier, name, sources, targets, child, multi, id, "tenantId", "createdBy", "updatedBy", "createdAt", "updatedAt", "deletedAt") FROM stdin;
\.
...
COPY public.roles (identifier, name, "configAccess", "relAccess", "itemAccess", id, "tenantId", "createdBy", "updatedBy", "createdAt", "updatedAt", "deletedAt") FROM stdin;
admin	Administrator	{"lovs": 2, "roles": 2, "types": 2, "users": 2, "actions": 2, "languages": 2, "relations": 2, "attributes": 2, "dashboards": 2}	{"access": 0, "groups": [], "relations": []}	{"valid": [], "access": 0, "groups": [], "fromItems": []}	1	default	system	system	2020-09-16 14:23:32.909034+03	2020-09-16 14:23:32.909034+03	\N
user	User	{"lovs": 0, "roles": 0, "types": 0, "users": 0, "actions": 0, "languages": 0, "relations": 0, "attributes": 0, "dashboards": 0}	{"access": 0, "groups": [], "relations": []}	{"valid": [], "access": 0, "groups": [], "fromItems": []}	2	default	system	system	2020-09-16 14:23:32.909034+03	2020-09-16 14:23:32.909034+03	\N
\.
